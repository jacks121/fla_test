# 花苗流程自动化开发计划（基于 2026-01-31 设计文档）
...
## 关键产出物
1) 事件驱动数据模型与 ERD（plant/dish/event/location/staff）
2) 事件类型字典（create/split/merge/place/status/transfer/void）
3) 扫码交互流程图（连扫、撤销、顺序校验）
4) 标签编码规范（二维码内容、短码格式）
5) 核心接口/API 列表与字段定义
6) MVP 前端页面清单（手机优先）
7) 试点上线与数据校验方案
